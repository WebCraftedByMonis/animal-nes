...
CREATE TABLE `Partner` (
    ...
    UNIQUE INDEX `Partner_partnerEmail_key`(`partnerEmail`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `AnimalNews` (
    ...
    UNIQUE INDEX `AnimalNews_title_key`(`title`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `JobApplicant` (
    ...
    `expectedPosition` TEXT NULL,
    `expectedSalary` VARCHAR(191) NULL,
    `preferredIndustry` TEXT NULL,
    `preferredLocation` TEXT NULL,
    `highestDegree` TEXT NULL,
    `degreeInstitution` TEXT NULL,
    `majorFieldOfStudy` TEXT NULL,
    `workExperience` TEXT NULL,
    `previousCompany` TEXT NULL,
    ...
    UNIQUE INDEX `JobApplicant_mobileNumber_key`(`mobileNumber`),
...
CREATE TABLE `monis` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `monisname` VARCHAR(191) NOT NULL,
