...
import { Cat, MenuIcon, Heart, ChevronDown, Video } from "lucide-react";
                  ...
                  <NavigationMenuItem>
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="start" className="w-52">
                        <DropdownMenuLabel className="text-xs text-muted-foreground">Live Sessions</DropdownMenuLabel>
                        <DropdownMenuSeparator />
                        ...
                        <DropdownMenuItem asChild>
                          ...
                          >
                            <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24">
                              <path d="M16.5 8.25v7.5L21 19.5V4.5L16.5 8.25z" fill="#00832D"/>
                              <rect x="3" y="6" width="13.5" height="12" rx="2" fill="#0066DA"/>
                            </svg>
                            Google Meet
                          </a>
                        </DropdownMenuItem>
                ...
                <DrawerContent className="max-h-[85vh]">
                  ...
                  <div className="flex flex-col px-4 py-4 space-y-3 overflow-y-auto">
                    ...
                    <div className="space-y-1">
                      ...
                      {/* Join Meeting (mobile) */}
                      <div className="pt-2">
                        <p className="px-3 py-1 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase flex items-center gap-1">
                          <Video className="h-3.5 w-3.5 text-green-500" /> Join Meeting
                        </p>
                        <DrawerClose asChild>
                          <a
                            href="https://teams.live.com/meet/9381024436336?p=5DZY54S6aSxvnXkQg3"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center gap-2 px-3 py-2.5 text-sm font-medium rounded-md hover:bg-green-500/10 hover:text-green-600 transition-colors"
                          >
                            <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill="none">
                              <path d="M12.5 3C9.46 3 7 5.46 7 8.5v.5H4a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h3v.5C7 21.54 9.46 24 12.5 24S18 21.54 18 18.5V8.5C18 5.46 15.54 3 12.5 3z" fill="#5059C9"/>
                              <path d="M19 7h-1V5.5A3.5 3.5 0 0 0 14.5 2h-1A3.5 3.5 0 0 0 10 5.5V7H9a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1V8a1 1 0 0 0-1-1z" fill="#7B83EB"/>
