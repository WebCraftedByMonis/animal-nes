  ...
  return (
    <NavigationMenu>
     <NavigationMenuList className="flex flex-col items-start md:flex-row md:items-center gap-0">
        ...
        <NavigationMenuItem>
          <NavigationMenuTrigger className="font-normal text-xs h-8 px-2 bg-transparent hover:bg-transparent data-[state=open]:bg-transparent"><span className="text-green-600 font-semibold">Marketplace</span></NavigationMenuTrigger>
          <NavigationMenuContent>
            <ul className="flex flex-col gap-3 p-4 md:w-[300px] lg:w-[300px] lg:grid-cols-[.75fr_1fr]">
        ...
        <NavigationMenuItem>
          <NavigationMenuTrigger className="font-normal text-xs h-8 px-2 bg-transparent hover:bg-transparent data-[state=open]:bg-transparent"><span className="text-green-600 font-semibold">Careers</span></NavigationMenuTrigger>
          <NavigationMenuContent>
