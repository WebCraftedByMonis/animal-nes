...
export default function FarmerDetailClient({ partner }: FarmerDetailClientProps) {
    ...
    return (
      <div className="max-w-7xl mx-auto p-10 text-center">
        <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-6 inline-block">
          <h2 className="text-xl font-semibold text-red-600 dark:text-red-400 mb-2">Farmer not found</h2>
          <p className="text-red-500 dark:text-red-400">
            The farmer you're looking for doesn't exist or may have been removed.
          </p>
        </div>
      </div>
    )
    ...
    <div className="max-w-7xl mx-auto p-6 space-y-8">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-lg shadow-md p-6 space-y-4">
            <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 flex items-center gap-2">
              <Tractor className="w-5 h-5 text-green-600 dark:text-green-500" />
              Farming Information
            </h2>
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 flex items-center gap-2">
              ...
              Associated Products ({partner.products.length})
            </h2>
            ...
            {partner.products.length > 0 ? (
              ...
              <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-12 text-center">
                ...
                <p className="text-gray-600 dark:text-gray-400">No products associated with this farmer yet.</p>
              </div>
            )}
          </div>
        </div>
