...
export default function EurovetsExtractor() {
  ...
  const handleExtract = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch("/api/scrape-products-eurovets", {
        method: "POST",
  ...
  return (
    <div className="max-w-full">
      <p className="text-gray-500 text-sm mb-1">
        Extract products from <span className="font-semibold text-gray-700">eurovets.ae</span> and add them directly to your store.
      </p>
      <p className="text-xs text-gray-400 mb-6">
        This extractor is configured for <span className="font-medium">Eurovets</span> (Odoo) — paste a shop or category URL to extract all products.
      </p>
          ...
          <div className="flex-1 min-w-[260px]">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="https://www.eurovets.ae/shop/category/new-products-205"
      ...
      {loading && (
        <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-lg text-blue-700 text-sm flex items-center gap-2">
          ...
          Fetching products from Eurovets (Odoo) — this may take a while for large catalogs…
        </div>
      )}
      ...
      {!loading && !rows.length && !fetchError && (
        <div className="text-center py-16 text-gray-400">
          ...
          <p className="text-sm">Enter a Eurovets shop or category URL above to get started.</p>
          <p className="text-xs mt-1 opacity-70">e.g. https://www.eurovets.ae/shop/category/new-products-205</p>
        </div>
      )}
    </div>
  );
