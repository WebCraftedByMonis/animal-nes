  ...
  return (
    <div className="max-w-full">
      ...
      <p className="text-xs text-gray-400 mb-6">
        This extractor is configured for <span className="font-medium">Pet World UAE</span> (WooCommerce) — paste any category URL to extract products with variants and descriptions.
      </p>
