...
export default function PetplaceExtractor() {
  ...
  const handleExtract = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch("/api/scrape-products-petplace", {
        method: "POST",
  ...
  return (
    <div className="max-w-full">
      <p className="text-gray-500 text-sm mb-1">
        Extract products from <span className="font-semibold text-gray-700">petplace.pk</span> and add them directly to your store.
      </p>
      <p className="text-xs text-gray-400 mb-6">
        This extractor is configured for <span className="font-medium">PetPlace PK</span> (WooCommerce) — paste any product category URL to extract products with all size variants and prices.
      </p>
          ...
          <div className="flex-1 min-w-[260px]">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="https://petplace.pk/product-category/cat-foods/cat-dry-food-in-pakistan/brit-cat-food/"
      ...
      {!loading && !rows.length && !fetchError && (
        <div className="text-center py-16 text-gray-400">
          ...
          <p className="text-sm">Enter a PetPlace category URL above to get started.</p>
          <p className="text-xs mt-1 opacity-70">e.g. https://petplace.pk/product-category/cat-foods/cat-dry-food-in-pakistan/brit-cat-food/</p>
        </div>
      )}
    </div>
  );
