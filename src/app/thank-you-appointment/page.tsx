        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
          <div className="flex items-start gap-3 mb-3">
            ...
            <div className="text-left">
              <p className="text-sm font-medium text-blue-800 mb-1">You will receive an email</p>
              <p className="text-xs text-blue-600">We'll send you doctor details and appointment confirmation</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="text-left">
              <p className="text-sm font-medium text-green-800 mb-1">Doctor Assignment</p>
              <p className="text-xs text-green-600">A qualified veterinarian will be assigned to your case</p>
            </div>
          </div>
        </div>
