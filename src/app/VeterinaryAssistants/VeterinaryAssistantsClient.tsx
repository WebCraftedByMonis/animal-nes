...
import {
  ...
  Stethoscope, GraduationCap, Award, Building2,
...
interface VeterinaryAssistantsClientProps {
  initialPartners: Partner[]
}

export default function VeterinaryAssistantsClient({ initialPartners }: VeterinaryAssistantsClientProps) {
  ...
  const fetchPartners = useCallback(async (searchTerm = search, spec = specialization) => {
    ...
    try {
      ...
      console.error('Fetch veterinary assistants error:', error)
      toast.error('Failed to fetch veterinary assistants')
      setPartners([])
      setTotal(0)
    } finally {
      setIsLoading(false)
    ...
    <div className="max-w-7xl mx-auto p-6 space-y-6">
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
          Find experienced veterinary assistants specialized in extension services, deworming, vaccination, and artificial insemination
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Select value={specialization} onValueChange={setSpecialization}>
            ...
            <SelectContent>
              ...
              <SelectItem value="EXTENSION (DEWORMING & VACCINATION)">Extension (Deworming & Vaccination)</SelectItem>
      ...
      <div className="flex justify-between items-center">
        <p className="text-gray-600 dark:text-gray-400">
          Found {total} veterinary assistant{total !== 1 ? 's' : ''}
        </p>
      </div>
      ...
      {partners.length === 0 ? (
        <div className="text-center py-12">
          <User2 className="w-16 h-16 text-gray-400 mx-auto mb-4" />
          <p className="text-xl text-gray-600 dark:text-gray-400 mb-2">No veterinary assistants found</p>
            ...
            <Card key={partner.id} className="hover:shadow-lg transition-shadow overflow-hidden group">
              <CardContent className="p-0">
                ...
                <div className="p-4 space-y-3">
                  ...
                  <div className="pt-2">
                    <Link 
                      href={`/VeterinaryAssistants/${partner.id}`}
