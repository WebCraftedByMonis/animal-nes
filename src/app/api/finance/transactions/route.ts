...
export async function GET(req: NextRequest) {
  try {
    ...
    // Country filter: filter auto-generated transactions by checkout country
    ...
    // Stats aggregate: completed transactions with country filter (no search filter)
    const statsWhere: any = { status: 'COMPLETED' }
    if (country && country !== 'all' && where.OR) {
