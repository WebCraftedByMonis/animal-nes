...
export default function SalesPartnerDetailClient({ initialData }: { initialData?: Partner | null }) {
  ...
  useEffect(() => {
    ...
    axios
      .get(`/api/partner/${numericId}?page=${productPage}&limit=${PRODUCTS_PER_PAGE}`)
      .then(({ data }) => {
        setPartner(data)
          ...
          <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-green-700 dark:text-green-300">{partner.totalProducts}</p>
              </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 flex items-center gap-2">
              ...
              Available Products ({partner.totalProducts})
            </h2>
