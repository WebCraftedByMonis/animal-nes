...
export default function AcceptedSellRequests() {
  ...
  useEffect(() => {
    const fetchAccepted = async () => {
      try {
        const res = await fetch('/api/sell-animal/accepted')
  ...
  if (!requests?.length) return <div className="p-4 text-muted-foreground">No accepted requests.</div>
