    ...
    try {
      ...
      if (res.ok) {
        ...
        setFormData({
          ...
          thankYouButtonText: form.thankYouButtonText || "",
          thankYouButtonUrl: form.thankYouButtonUrl || "",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        toast.error(error.error || "Failed to update form", { id: toastId });
      }
    } catch (error) {
      console.error("Error updating form:", error);
      toast.error("An error occurred while updating form", { id: toastId });
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="p-6 max-w-5xl mx-auto">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-1">Update your custom form and fields</p>
        </div>
      </div>
